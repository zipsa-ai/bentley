...
TARGET_REPO_NAME = os.environ.get("TARGET_REPO_NAME", "zipsa-ai.github.io")  # target repo 이름
...
# 설정
TARGET_REPO_URL = f"https://{GITHUB_TOKEN}@github.com/{GITHUB_USERNAME}/{TARGET_REPO_NAME}.git"
...
def commit_to_another_repo(markdown_content):
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        # 2. Write file
        posts_path = os.path.join(tmpdir, "content/posts")
...
if __name__ == "__main__":
    ...
    commit_to_another_repo(title, summary)
